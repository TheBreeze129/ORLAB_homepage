...
import publication_image from "../assets/publication.jpg";
    ...
    const fetchData = async () => {
      try {
        const response = await fetch("/api/page", {
          method: "GET",
          headers: {
            pageCode: process.env.REACT_APP_PUBLICATION,
          },
        });
    ...
    <Outer>
      ...
      <HeroContainer>
        <HeroContent>
          ...
          <Description>Research Publications from ORLAB</Description>
        </HeroContent>
        <ImageWrapper>
          <StyledImage src={publication_image} alt="Students" />
        </ImageWrapper>
      </HeroContainer>
