...
function Seminar() {
  ...
  useEffect(() => {
    if (year === "2025") {
      setToken(process.env.REACT_APP_SEMINAR_2025);
    } else if (year === "2024") {
      setToken(process.env.REACT_APP_SEMINAR_2024);
    } else if (year === "2023") {
      setToken(process.env.REACT_APP_SEMINAR_2023);
    } else if (year === "2022") {
      setToken(process.env.REACT_APP_SEMINAR_2022);
    } else if (year === "2021") {
      setToken(process.env.REACT_APP_SEMINAR_2021);
    }
  }, [year]);
  ...
  return (
    <Outer>
      ...
      <HeroContainer>
        <HeroContent>
          <Title>Seminar : {year}</Title>
          <Description>Operation Research Lab's Seminar in {year}</Description>
        </HeroContent>
        <ImageWrapper>
          <StyledImage src={yonseiImage} alt="Seminar" />
        </ImageWrapper>
      </HeroContainer>
        ...
        {token === "" ? (
          ...
          <>
            ...
            seminars.length > 0 ? (
              ...
              <Heading>No seminar data available.</Heading>
            )}
          </>
        )}
      </Container>
